...
<form:form id="socioForm" method="POST" commandName="socio" cssClass="form-horizontal">
    <form:errors/>
    <div class="form-group">

		 
        <label for="numeroInscricao" class="col-lg-2 control-label">Número de Inscrição</label>
        <div class="col-lg-10">
